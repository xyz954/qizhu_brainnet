...
CAT1 = [
    ...
    {'a': 'Jinrong Cui, Weihao Ye, Shengrong Li, Jie Wen, Qi Zhu*',
     ...
     'v': 'IEEE Transactions on Medical Imaging',
     'y': 2026,
     'doi': '10.1109/TMI.2026.3654000'},
    {'a': 'Jinrong Cui, Weihao Ye, Jie Wen, Qi Zhu*',
     't': 'Dual-contrastive modality recovery for incomplete multi-modal brain disease diagnosis',
     'v': 'Medical Image Analysis',
     'y': 2026,
     'doi': ''},
    {'a': 'Yixin Ji, Vince D Calhoun, Jin Zhang, Qi Zhu, Shengrong Li, Daniel H Mathalon, Si Yong Yeo, Daoqiang Zhang, Shile Qi',
     ...
     'v': 'IEEE Transactions on Biomedical Engineering',
     'y': 2026,
     'doi': '10.1109/TBME.2026.3658874'},
    {'a': 'Lin Zhao, Cheng Ding, Shengrong Li, Chunwei Tian, Chao Huang, Donghai Guan, Daoqiang Zhang, Qi Zhu*',
     't': 'A Unified Graph Domain Adaptation Framework for Cross-Site Brain Network Analysis',
     'v': 'IEEE Transactions on Medical Imaging',
     'y': 2026,
     'doi': ''},
    ...
    {'a': 'Ning Yuan, Donghai Guan, Shengrong Li, Li Zhang, Qi Zhu*',
     ...
     'v': 'IEEE Transactions on Neural Systems and Rehabilitation Engineering',
     'y': 2025,
     'doi': '10.1109/tnsre.2025.3564983',
     'code': 'https://github.com/YNingCode/CD-DSTCN'},
    {'a': 'Shengrong Li, Qi Zhu*, Liang Sun, Kai Ma, Yixin Ji, Shile Qi, Daoqiang Zhang',
     ...
     'v': 'IEEE Transactions on Consumer Electronics',
     'y': 2025,
     'doi': '10.1109/TCE.2025.3563691'},
    ...
    {'a': 'Shengrong Li, Qi Zhu*, Chunwei Tian, Xinyang Zhang, Wei Shao, Jie Wen*, Daoqiang Zhang',
     't': 'NeuroH-TGL: Neuro-Heterogeneity Guided Temporal Graph Learning Strategy for Brain Disease Diagnosis',
     'v': 'Advances in Neural Information Processing Systems (NeurIPS)',
     'y': 2025,
     'doi': '10.52202/085713-3647'},
    ...
    {'a': 'Qi Zhu, Jing Yang, Shuihua Wang, Daoqiang Zhang, Zheng Zhang',
     ...
     'v': 'IEEE Transactions on Emerging Topics in Computational Intelligence',
     'y': 2023,
     'doi': '10.1109/tetci.2022.3171855'},
]
...
CAT2 = [
    {'a': 'Kun Wang, Qi Zhu*, Junyong Zhao, Chuhang Zheng, Wei Shao, Daoqiang Zhang*',
     ...
     'v': 'IEEE Transactions on Emerging Topics in Computational Intelligence',
     'y': 2026,
     'doi': '10.1109/TETCI.2025.3647679',
     'fig': 'images/works/cat3-r1.png',
    ...
    {'a': 'Kun Wang, Qi Zhu*, Bo Qian, Mingming Wang, Liying Zhang, Shengrong Li, Daoqiang Zhang*',
     't': 'Hash Prototype Personalized Federated Learning for Multi-Site Brain Network Analysis',
     'v': 'IEEE Transactions on Cognitive and Developmental Systems',
     'y': 2026,
     'doi': '10.1109/TCDS.2026.3718301'},
    {'a': 'Yiheng Liu, Chuhang Zheng, Peiliang Gong, Jingtao Liu, Daoqiang Zhang, Qi Zhu*',
     't': 'FSDBN: Foreground-Aware EEG-Visual Alignment via Dynamic Brain Networks',
     'v': 'arXiv preprint arXiv:2607.18344',
     'y': 2026,
     'doi': '10.48550/arXiv.2607.18344',
     'code': 'https://github.com/LiuYiheng1/FSDBN-EEG',
     'note': 'Accepted by ACM MM 2026'},
    {'a': 'Minxu Liu, Donghai Guan*, Chuhang Zheng, Chunwei Tian, Jie Wen, Qi Zhu',
     't': 'ViEEG: Hierarchical Visual Neural Representation for EEG Brain Decoding',
     'v': 'arXiv preprint arXiv:2505.12408',
     'y': 2026,
     'doi': '10.48550/arXiv.2505.12408',
     'note': 'Accepted by NeurIPS 2026'},
    ...
    {'a': 'Qi Zhu, Ting Zhu, Lunke Fei, Chuhang Zheng, Wei Shao, David Zhang, Daoqiang Zhang',
     ...
     'v': 'IEEE Transactions on Affective Computing',
     'y': 2025,
...
# ---------------- AI Interdisciplinary Applications (17) ----------------
CAT3 = [
    {'a': 'Lunke Fei, Xin Wang, Qi Zhu, Shuping Zhao, Jie Wen, Jian Zhu, Xiaomin Hu',
     't': 'Learning to Estimate 3D Hand Pose from Depth Image',
     'v': 'IEEE Transactions on Multimedia',
     'y': 2026,
     'doi': '10.1109/TMM.2026.3724754',
     'fig': 'images/works/cat3-r3.png',
     'desc': 'This paper proposes an attention-based graph convolutional network (AttGCN) for 3D hand pose estimation, learning fine-grained hand-joint features in a coarse-to-fine manner.'},
    {'a': 'Lunke Fei, Kaiting Huang, Shuping Zhao, Qi Zhu, Bob Zhang, Wei Jia',
     ...
     'v': 'IEEE Transactions on Systems, Man, and Cybernetics: Systems',
     'y': 2026,
     'doi': '10.1109/TSMC.2025.3647704'},
    ...
    {'a': 'Zhu Wang, Lunke Fei, Shuping Zhao, Bob Zhang, Qi Zhu, Imad Rida',
     ...
     'fig': 'images/works/cat3-r5.png',
     'desc': 'This paper proposes a palm intrinsic feature learning selective state space model for palmprint image denoising, integrating shallow feature representation, noise-insensitive palmprint-specific feature learning, and sharp palmprint image restoration in a unified framework.'},
    ...
    {'a': 'Lunke Fei, Zhihao He, Wai Keung Wong, Qi Zhu, Shuping Zhao, Jie Wen',
     ...
     'y': 2025,
     'doi': '10.1016/j.patcog.2024.111225'},
    ...
    {'a': 'Qiming Yang, Qi Zhu*, Mingming Wang, Wei Shao*, Zheng Zhang, Daoqiang Zhang',
     ...
     'v': 'IEEE Transactions on Big Data',
     'y': 2023,
...
CATS = [
    ('Brain Network Analysis', '脑网络分析', CAT1, [1, 6, 7, 13]),
    ('Brain-Computer Interfaces', '脑机接口', CAT2, [1, 5, 6, 8]),
    ('AI Interdisciplinary Applications', '人工智能交叉应用', CAT3, [1, 5, 12]),
]
